...
def main():
    ...
    enable_carrotd = config["components"].getboolean("ENABLE_CARROTD")

    if config["environment"]["EXEEXT"] == ".exe" and not args.force:
        # https://github.com/CarrotProject/Carrotcoin/commit/d52802551752140cf41f0d9a225a43e84404d3e9
        # https://github.com/CarrotProject/Carrotcoin/pull/5677#issuecomment-136646964
...
def run_tests(test_list, src_dir, build_dir, exeext, tmpdir, jobs=1, enable_coverage=False, args=[]):
    ...
    #Set env vars
    if "CARROTD" not in os.environ:
        os.environ["CARROTD"] = build_dir + '/src/carrotd' + exeext
        os.environ["CARROTCLI"] = build_dir + '/src/carrot-cli' + exeext
