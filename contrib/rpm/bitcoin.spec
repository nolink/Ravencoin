...
%{_sbindir}/semanage port -a -t carrot_port_t -p tcp 8766
%{_sbindir}/semanage port -a -t carrot_port_t -p tcp 8767
%{_sbindir}/semanage port -a -t carrot_port_t -p tcp 18766
%{_sbindir}/semanage port -a -t carrot_port_t -p tcp 18767
%{_sbindir}/semanage port -a -t carrot_port_t -p tcp 18443
%{_sbindir}/semanage port -a -t carrot_port_t -p tcp 18444
